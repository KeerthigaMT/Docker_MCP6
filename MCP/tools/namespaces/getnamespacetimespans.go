...
func GetnamespacetimespansHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/namespaces/%s/pulls/exports/years/%s/%s", cfg.BaseURL, namespace, year, timespantype)
		...
		var result models.TimespanData
...
func CreateGetnamespacetimespansTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_namespaces_namespace_pulls_exports_years_year_timespantype",
		mcp.WithDescription("Get timespans with data"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetnamespacetimespansHandler(cfg),
	}
}
